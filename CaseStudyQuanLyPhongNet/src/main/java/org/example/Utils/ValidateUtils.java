...
public class ValidateUtils {
    ...
    public static final String REGEX_PASSWORD = "^.{1,20}$";
    ...
    public static final String FIELD_USER_MESSAGE = "Có ít nhất 4 kí tự";
    public static final String FIELD_PASSWORD_MESSAGE = "Mật khẩu phải có độ dài từ 1-20 ký tự ";
